...
function selectCompany(reduce, companyName) {
  ...
  CompanyService.fetchEmployees(companyName).then((function (employees) {
...
function loadCompanies(reduce) {
  CompanyService.fetchCompanies(/* () */0).then((function (companies) {
          Curry._2(reduce, (function () {
...
function executeQuery(reduce, query) {
  CompanyService.fetchSearch(query).then((function (results) {
          Curry._2(reduce, (function () {
...
function make() {
  ...
  newrecord[/* render */9] = (function (param) {
      ...
      return React.createElement("div", undefined, ReasonReact.element(/* None */0, /* None */0, Header.make(state[/* query */3], (function ($$event) {
                          ...
                          }), /* array */[])), match !== 0 ? ReasonReact.element(/* None */0, /* None */0, SearchResults.make(state[/* results */4], /* array */[])) : ReasonReact.element(/* None */0, /* None */0, CompanyList.make(state[/* companies */0], state[/* employees */1], state[/* selectedCompany */2], (function (name) {
