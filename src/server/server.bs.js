...
console.log("Current directory: " + Utils$ReactTemplate.getOpt(/* tuple */[
          $$__dirname$1,
          "-"
        ]));
...
var CompanyNotFound = Caml_exceptions.create("Server-ReactTemplate.CompanyNotFound");

var NameFieldMissing = Caml_exceptions.create("Server-ReactTemplate.NameFieldMissing");

var QueryFieldMissing = Caml_exceptions.create("Server-ReactTemplate.QueryFieldMissing");

var EmployeeFieldMissig = Caml_exceptions.create("Server-ReactTemplate.EmployeeFieldMissig");

function getBody(param) {
  var body = param[0];
  if (body) {
    return Utils$ReactTemplate.getDictString(body[0], param[1]);
  } else {
    return /* None */0;
  }
}
...
app.get("/employees", (function (req, res, _) {
        ...
        var name = Utils$ReactTemplate.getOptExc(/* tuple */[
              Utils$ReactTemplate.getDictString(reqData, "name"),
              NameFieldMissing
            ]);
...
app.get("/search", (function (req, res, _) {
        var query = Utils$ReactTemplate.getOptExc(/* tuple */[
              Utils$ReactTemplate.getDictString(req.query, "query"),
              QueryFieldMissing
            ]);
        ...
        var jsonResults = $$Array.map((function (name) {
                return name;
                          ...
                          return Utils$ReactTemplate.contains(/* tuple */[
                                      name,
                                      query
                                    ]);
                        }))(names)));
...
app.post("/companies", (function (req, res, _) {
        ...
        return res.json(Utils$ReactTemplate.makeSuccessJson(/* () */0));
      }));

app.post("/employees", (function (req, res, _) {
        var body = Utils$ReactTemplate.getDictObject(req, "body");
        try {
          var name = Utils$ReactTemplate.getOptExc(/* tuple */[
                getBody(/* tuple */[
                      body,
          ...
          var firstName = Utils$ReactTemplate.getOptExc(/* tuple */[
                getBody(/* tuple */[
                      body,
                      "firstName"
                    ]),
          ...
          var lastName = Utils$ReactTemplate.getOptExc(/* tuple */[
                getBody(/* tuple */[
                      body,
                      "lastName"
                    ]),
          ...
          var birthday = Utils$ReactTemplate.getOptExc(/* tuple */[
                getBody(/* tuple */[
                      body,
                      "birthday"
                    ]),
          ...
          var salary = Utils$ReactTemplate.getOpt(/* tuple */[
                getBody(/* tuple */[
                      body,
                      "salary"
                    ]),
          ...
          if (exn === CompanyNotFound) {
            return res.json(Utils$ReactTemplate.makeFailureJson("Company name was not found"));
          } else if (exn === EmployeeFieldMissig) {
            return res.json(Utils$ReactTemplate.makeFailureJson("One of required employee fields is missing"));
          } else {
            throw exn;
          }
        }
...
var statics = Utils$ReactTemplate.getOpt(/* tuple */[
      $$__dirname$1,
      "/"
    ]);
